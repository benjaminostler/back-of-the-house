...
@router.post("/menu_items", response_model=Union[MenuItemsOut, Error], tags=["Menu Items"])
...
@router.get("/menu_items", response_model=Union[Error, List[MenuItemsOut]], tags=["Menu Items"])
def list_menu_items(
...
@router.put(
    "/menu_items/{menu_item_id}", response_model=Union[MenuItemsOut, Error], tags=["Menu Items"]
)
...
@router.delete("/menu_items/{menu_item_id}", response_model=bool(), tags=["Menu Items"])
