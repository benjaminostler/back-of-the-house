...
@router.post("/menu_item", response_model=Union[MenuItemsOut, Error], tags=["Menu Items"])
...
@router.get("/menu_item", response_model=Union[Error, List[MenuItemsOut]], tags=["Menu Items"])
def list_menu_items(
...
@router.put(
    "/menu_item/{menu_item_id}", response_model=Union[MenuItemsOut, Error], tags=["Menu Items"]
)
